...
namespace AmdgoInterno.Afip
{
    public class AfipHomoDatos
    {
        ...
        public AfipHomoLog login { get; set; }
        ...
        private long Cuitempresa { get; set; } = 20365790486; //SOLO HOMOLOGACION
        ...
        public bool loginafip(string certificadodir, string clavecert, long cuit)
        {
            ...
            {
                Cuitempresa = cuit;
                AfipHomoLog log = new AfipHomoLog(certificadodir, clavecert);
                log.urlWSDL = "https://wswhomo.afip.gov.ar/wsfev1/service.asmx?wsdl";
                log.server = "wsfe";
            ...
            string fecsrvhasta, string fecvtopago, string tipocomprob, string letra)
        {
            ...
            detalle.DocNro = cuitcomp;                        //numero de documento del comprador (sin ningun tipo decaracter)
            ...
            if (concepto == 2 || concepto == 3)
            {
                ...
                detalle.FchVtoPago = fecvtopago;
            }

            //FECHAS PARA FCC
            if (TipoComprobante == "FCE") { detalle.FchVtoPago = fecvtopago; }
        ...
        public string solicitaAprobacion()
        {
            ...
            try
            {
                ...
                if (respuesta.Errors != null)
                {
                    ...
                    {
                        m += String.Format("Err: {0} - {1}", Errors.Code, Errors.Msg);
                    }
                }
        ...
        public void setOpcionaltipotrans()
        {
            opcionales.Add(new Opcional
            {
                Id = "27",
