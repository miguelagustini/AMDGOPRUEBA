...
{
    public partial class Frm_Extras : XtraForm
    {
        ...
        public List<DiscusionExtra> extralist = new List<DiscusionExtra>(); 
        ...
        private void CargaRegistros()
        {
            try
            {
                ...
                gridControl.DataSource = extralist;
        ...
        private void gridView_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                gridView.BeginDataUpdate();
                extralist.Add(new DiscusionExtra());
                gridView.EndDataUpdate();
