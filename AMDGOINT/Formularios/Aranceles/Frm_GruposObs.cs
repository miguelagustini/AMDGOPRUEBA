...
{
    public partial class Frm_GruposObs : XtraForm
    {
        ...
        public List<DiscusionGrupoObs> gruposlst = new List<DiscusionGrupoObs>(); 

        public bool Es_Popup { get; set; } = false;
        
        public Frm_GruposObs()
        {
            InitializeComponent();
        ...
        private void CargaRegistros()
        {
            try
            {
                ...
                gridControl.DataSource = gruposlst;
