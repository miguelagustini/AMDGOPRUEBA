...
{
    public class DevolucionesEventos : INotifyPropertyChanged
    {
        ...
        private static string tablaname = "[AmdgoInterno].[dbo].[DevolucionesEventos]";
        ...
        //CONSTRUCTOR VACIO
        public DevolucionesEventos() { }

        public DevolucionesEventos(SqlConnection conexion)
        {
        ...
        //CLONE 
        public DevolucionesEventos Clone()
        {
            DevolucionesEventos r = (DevolucionesEventos)MemberwiseClone();
            return r;
        }

        //CLONE CON LISTAS
        public List<DevolucionesEventos> Clone(List<DevolucionesEventos> lst)
        {
            List<DevolucionesEventos> lista = new List<DevolucionesEventos>();

            foreach (DevolucionesEventos d in lst)
            {
                lista.Add(d.Clone());
            }
        ...
        public List<DevolucionesEventos> GetRegistros()
        {
            try
            {
                ...
                string c = $"SELECT RE.IDRegistro, RE.IDEncabezado, RE.IDEvento, RE.Fecha, RE.Observacion" +
                           $" FROM {tablaname} RE";                           
                ...
                using (SqlCommand cmd = new SqlCommand(c, SqlConnection.State != ConnectionState.Open ? cnb.Conectar() : SqlConnection))
                {
                    ...
                    lista.AddRange(func.ConvertToList<DevolucionesEventos>(rdr));
                }
            ...
            catch (Exception e)
            {
                ...
                return new List<DevolucionesEventos>();
            }
        }
