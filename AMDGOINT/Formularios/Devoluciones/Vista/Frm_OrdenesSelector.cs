...
{
    public partial class Frm_OrdenesSelector : XtraForm
    {
        ...
        private void BusqDetalles()
        {
            try
            {
                ...
                Detalles.Clear();
                Detalles.AddRange(Detalle.GetOrdenesAmbulatorias(PrestadorID, Periodo));
        ...
        private void Frm_OrdenesSelector_Load(object sender, EventArgs e)
        {

        }

        private void Frm_OrdenesSelector_Shown(object sender, EventArgs e)
        {
            ParametrosInicio();
        }

        private void Frm_OrdenesSelector_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
