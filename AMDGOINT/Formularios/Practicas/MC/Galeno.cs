...
{
    public class Galeno : INotifyPropertyChanged
    {
        ...
        // PROPIEDADES 
        #region PROPIEDADES        
        private static string tablaname = "ARANCELES";
        ...
        public Galeno(SqlConnection conexion) { SqlConnection = conexion; }
        ...
        public Galeno Clone()
        {
            Galeno d = (Galeno)MemberwiseClone();
            return d;

        }

        //CLONE CON LISTAS
        public List<Galeno> Clone(List<Galeno> lst)
        {
            List<Galeno> lista = new List<Galeno>();

            foreach (Galeno d in lst)
            {
                lista.Add(d.Clone());
            }
        ...
        public List<Galeno> GetRegistros()
        {
            try
            {
                List<Galeno> lista = new List<Galeno>();
