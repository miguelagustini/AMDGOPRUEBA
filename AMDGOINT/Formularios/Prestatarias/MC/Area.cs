...
namespace AMDGOINT.Formularios.Prestatarias.MC
{
    public class Area : INotifyPropertyChanged
    {
        ...
        private static string tablaname = "[AmdgoInterno].[dbo].[AREASTRABAJO]";
        ...
        {
            get { return _area; }
            set { _area = _area != value.Trim() ? value.Trim() : _area; }
        }
        ...
        public Area(SqlConnection conexion)
        {
        ...
        public Area Clone()
        {
            Area d = (Area)MemberwiseClone();            
            return d;

        }

        //CLONE CON LISTAS
        public List<Area> Clone(List<Area> lst)
        {
            List<Area> lista = new List<Area>();

            foreach (Area d in lst)
            {
                lista.Add(d.Clone());
            }
        ...
        public List<Area> GetRegistros()
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand(c, SqlConnection.State != ConnectionState.Open ? cnb.Conectar() : SqlConnection))
                {
                    ...
                    lista.AddRange(func.ConvertToList<Area>(rdr));
                }
        ...
        public short GetbyDescripcion()
        {
            ...
            try
            {
                ...
                string c = $"SELECT IDRegistro FROM {tablaname} WHERE Descripcion = '{Descripcion}'";
