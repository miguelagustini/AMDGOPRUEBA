...
{
    public class RetencionGanancias: INotifyPropertyChanged
    {
        ...
        // PROPIEDADES 
        #region PROPIEDADES        
        private static string tablaname = "[AmdgoInterno].[dbo].PROFEXRETGANANCIAS";
        ...
        public RetencionGanancias() { }

        public RetencionGanancias(SqlConnection conexion) { SqlConnection = conexion; }
        ...
        //CLONE 
        #region CLONACION
        public RetencionGanancias Clone()
        {
            RetencionGanancias d = (RetencionGanancias)MemberwiseClone();
            return d;

        }

        //CLONE CON LISTAS
        public List<RetencionGanancias> Clone(List<RetencionGanancias> lst)
        {
            List<RetencionGanancias> lista = new List<RetencionGanancias>();

            foreach (RetencionGanancias d in lst)
            {
                lista.Add(d.Clone());
            }
        ...
        public List<RetencionGanancias> GetRegistros()
        {
            try
            {
                List<RetencionGanancias> lista = new List<RetencionGanancias>();
                ...
                using (SqlCommand cmd = new SqlCommand(c, SqlConnection.State != ConnectionState.Open ? cnb.Conectar() : SqlConnection))
                {
                    ...
                    lista.AddRange(func.ConvertToList<RetencionGanancias>(rdr));
                }
            ...
            catch (Exception e)
            {
                ...
                return new List<RetencionGanancias>();
            }
        }
