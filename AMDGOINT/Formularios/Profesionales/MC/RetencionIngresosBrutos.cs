...
{
    public class RetencionIngresosBrutos: INotifyPropertyChanged
    {
        ...
        // PROPIEDADES 
        #region PROPIEDADES        
        private static string tablaname = "[AmdgoInterno].[dbo].PROFEXINGRESOSBRUTOS";
        ...
        public RetencionIngresosBrutos() { }

        public RetencionIngresosBrutos(SqlConnection conexion) { SqlConnection = conexion; }
        ...
        //CLONE 
        #region CLONACION
        public RetencionIngresosBrutos Clone()
        {
            RetencionIngresosBrutos d = (RetencionIngresosBrutos)MemberwiseClone();
            return d;

        }

        //CLONE CON LISTAS
        public List<RetencionIngresosBrutos> Clone(List<RetencionIngresosBrutos> lst)
        {
            List<RetencionIngresosBrutos> lista = new List<RetencionIngresosBrutos>();

            foreach (RetencionIngresosBrutos d in lst)
            {
                lista.Add(d.Clone());
            }
        ...
        public List<RetencionIngresosBrutos> GetRegistros()
        {
            try
            {
                List<RetencionIngresosBrutos> lista = new List<RetencionIngresosBrutos>();
                ...
                using (SqlCommand cmd = new SqlCommand(c, SqlConnection.State != ConnectionState.Open ? cnb.Conectar() : SqlConnection))
                {
                    ...
                    lista.AddRange(func.ConvertToList<RetencionIngresosBrutos>(rdr));
                }
            ...
            catch (Exception e)
            {
                ...
                return new List<RetencionIngresosBrutos>();
            }
        }
