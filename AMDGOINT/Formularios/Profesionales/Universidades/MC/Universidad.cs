...
namespace AMDGOINT.Formularios.Profesionales.Universidades.MC
{
    public class Universidad : INotifyPropertyChanged
    {
        ...
        // PROPIEDADES 
        #region PROPIEDADES        
        private static string tablaname = "PROFUNIVERSIDADES";
        ...
        public Universidad(SqlConnection conexion) { SqlConnection = conexion; }
        ...
        #region CLONACION
        //CLONE 
        public Universidad Clone()
        {
            Universidad d = (Universidad)MemberwiseClone();
        ...
        //CLONE CON LISTAS
        public List<Universidad> Clone(List<Universidad> lst)
        {
            List<Universidad> lista = new List<Universidad>();

            foreach (Universidad d in lst)
            {
                lista.Add(d.Clone());
            }
        ...
        //RETORNO LISTA 
        public List<Universidad> GetRegistros()
        {
            try
            {
                List<Universidad> lista = new List<Universidad>();
