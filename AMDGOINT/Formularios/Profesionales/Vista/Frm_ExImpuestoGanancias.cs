...
{
    public partial class Frm_ExImpuestoGanancias : XtraForm
    {
        private Controles ctrls = new Controles();
        private int idprofesional = 0;
        public SqlConnection SqlConnection { get; set; } = new SqlConnection();

        public List<MC.RetencionGanancias> ImpuestoGanancias = new List<MC.RetencionGanancias>();
        ...
        public Frm_ExImpuestoGanancias()
        {
            InitializeComponent();
        }
        ...
        private void AsignaDatos()
        {
            try
            {
                ...
                gridControl.DataSource = new BindingList<MC.RetencionGanancias>(ImpuestoGanancias);
