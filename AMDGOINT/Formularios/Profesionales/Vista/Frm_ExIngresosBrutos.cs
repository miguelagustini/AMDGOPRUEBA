...
{
    public partial class Frm_ExIngresosBrutos : XtraForm
    {
        private Controles ctrls = new Controles();
        private int idprofesional = 0;
        public SqlConnection SqlConnection { get; set; } = new SqlConnection();
        
        public List<MC.RetencionIngresosBrutos> IngresosBrutos = new List<MC.RetencionIngresosBrutos>();
        ...
        private void AsignaDatos()
        {
            try
            {
                ...
                gridControl.DataSource = new BindingList<MC.RetencionIngresosBrutos>(IngresosBrutos);
