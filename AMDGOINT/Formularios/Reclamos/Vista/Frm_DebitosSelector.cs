...
{
    public partial class Frm_DebitosSelector : XtraForm
    {
        ...
        private MC.ReclamosDet Detalle = new MC.ReclamosDet();
        public int PrestatariaCuentaID { get; set; }
        public string Periodo { get; set; }
        public SqlConnection SqlConnection { get; set; } = new SqlConnection();

        public Frm_DebitosSelector()
        {
            InitializeComponent();
        }
        ...
        private void BusqDetalles()
        {
            try
            {
                ...
                Detalles.Clear();
                Detalles.AddRange(Detalle.GetDebitos(PrestatariaCuentaID, Periodo));
        ...
        private void MarcaSeleccionado()
        {
            try
            {
                ...
                {
                    MC.ReclamosDet d = gridView.GetRow(i) as MC.ReclamosDet;
                    if (d == null) { return; }
